...
-- Volcando datos para la tabla tiendaexoticshoes.appexoticshoes_productos: ~11 rows (aproximadamente)
REPLACE INTO `appexoticshoes_productos` (`id`, `nombre`, `descripcion`, `precio`, `cantidadEnInventario`, `foto`, `estado`, `categoria_id`) VALUES
	...
	(6, 'Aretes b', 'Aretes dorados unicos en acero inoxidabñe', 50000.00, 5, 'productos/aretes.jpg', 1, 3),
	(7, 'collar perlado', 'collar perlado gris', 158000.00, 5, 'productos/collar.jpg', 1, 3),
	(8, 'blusa blanca', 'blusa blanca seda blanca talla unica', 25000.00, 10, 'productos/stable-diffusion-xl_6.jpg', 1, 2),
	(9, 'qw', 'eqw', 324.00, 3223, 'productos/stable-diffusion-xl_4.jpg', 1, 2),
	(10, 'qwerw', 'erwqr', 32434.00, 23, 'productos/stable-diffusion-xl_1.jpg', 1, 2),
	(11, 'bnmmvnm', 'dcgfdgdfsg', 400000.00, 34, 'productos/stable-diffusion-xl_5.jpg', 1, 3);
...
-- Volcando datos para la tabla tiendaexoticshoes.auth_group_permissions: ~36 rows (aproximadamente)
...
-- Volcando datos para la tabla tiendaexoticshoes.auth_user: ~2 rows (aproximadamente)
REPLACE INTO `auth_user` (`id`, `password`, `last_login`, `is_superuser`, `username`, `first_name`, `last_name`, `email`, `is_staff`, `is_active`, `date_joined`) VALUES
	(1, 'pbkdf2_sha256$600000$j6vdn897Mwqp23Xbe0IGZu$S8UGu03lxyAWxo0T3GrkodvHBak+RihPxb5bPTMW8d4=', '2023-08-09 18:21:36.102835', 1, 'admin', 'Juan David', 'Chimbaco Herrera', 'dajun318@gmail.com', 1, 1, '2023-07-22 21:48:31.000000'),
...
-- Volcando datos para la tabla tiendaexoticshoes.django_admin_log: ~4 rows (aproximadamente)
...
REPLACE INTO `django_session` (`session_key`, `session_data`, `expire_date`) VALUES
	('9l3kaeob667saw6sfi1fjekwaql734vs', '.eJxVjMsOwiAURH9FWRvCow9x6Vr_wIRc4NKiFZJSEhPjv0uTLnQzizkz5000lGXUJeOsgyMnwsnhtzNgHxhX4O4Qh0RtisscDF0ndKOZXpPD6bxt_wQj5LG-jeo8eCFa0fS9b5lkQjhADkevOomdckJKb2vRMOMFd41E4Nyi8EpJ8FU6pSFEnYu1mLN-1oABq_pWGAN-WekOX2FJOe3J5wvB0EjP:1qTnoO:11xS3eBpuQqfo5aDaSRnx860-kNYcCSrmnIuE_I6U70', '2023-08-23 18:21:36.110558'),
