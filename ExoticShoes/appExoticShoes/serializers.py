...
from .models import  Stock, Usuario, Categoria, Producto, Pedido, DetallePedido, Pago, Envio, Devolucione, CartItem , Cart , ImagenProducto, Talla
...
class LoginUsuarioSerializer(serializers.Serializer):
    ...
    password = serializers.CharField(write_only=True)  # Marcar la contraseña como solo escritura
